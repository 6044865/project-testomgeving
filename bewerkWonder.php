...
// Verwijder foto
// ================================
if ($rol === 'beheerder' && isset($_POST['delete_foto_id'])) {
...
if ($rol === 'beheerder' && isset($_POST['delete_document_id'])) {
...
if (isset($_POST['submit_form'])) {
    ...
    // Foto upload
    // ================================
    if ($rol === 'beheerder' && isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
        $bestand = $_FILES['foto'];
